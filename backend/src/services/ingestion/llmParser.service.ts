...
Your job is to parse messy lines of text from study sheets and convert them into structured DSA problems.
Rules:
...
4. If no questions are found, set containsProblems to false and problems to [].`,
    prompt: `Parse the following extracted text snippet:\n\n${textPayload}`,
  });
